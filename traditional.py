...
with open('dam3_seperated.pkl', 'rb') as f:
...
start_date = datetime.datetime(2021,8,8,0,0)
end_date = datetime.datetime(2021,8,15,0,0)
...
start_index = np.where(date>=datetime.datetime(2021,8,9,0,0))[0][0]
end_index = np.where(date>=datetime.datetime(2021,8,15,0,0))[0][0]
